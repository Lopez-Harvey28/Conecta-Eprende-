...
export function createDemoAuthUser(option:DemoProfileOption):AuthUser {
  ...
  return {
    ...
    providers:provider?[{id:provider.id,displayName:provider.publicName,slug:provider.id,verified:provider.verificationLevel==="COMPLETE"}]:[],
  };
}
...
export const demoProviders:ProviderProfile[]=[
  ...
  {
    id:"provider_high_trust_demo",ownerUserId:"user_provider_active_demo",publicName:"Demo Alta Confianza",tagline:"Perfil activo con señales fuertes.",city:"Granada",category:"Empaques ecológicos",description:"Proveedor demo de alta confianza para comparar señales de reputación y actividad bilateral completada.",serviceArea:["Granada","Managua"],services:["Cajas reciclables","Etiquetas biodegradables"],priceRange:"HIGH",availability:"AVAILABLE",portfolioImages:[demoImage],formalizationStatus:"MIPYME",verificationLevel:"COMPLETE",trustScore:96,medals:["Perfil completo","Actividad verificada","Confianza alta"],responseTimeHrs:1,completedRequests:32,profileCompleteness:100,lat:11.936,lng:-85.958,contactPreference:"Mensajes de la plataforma",createdAt:demoIssuedAt,updatedAt:demoUpdatedAt,profileStatus:"ACTIVE",avgRating:4.9,totalVerifiedReviews:24,
  },
  {
