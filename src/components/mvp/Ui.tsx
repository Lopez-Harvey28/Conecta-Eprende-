...
import { Award, BadgeCheck, CheckCircle2, Clock3, ShieldCheck } from "lucide-react";
...
export const statusLabel: Record<RequestStatus,string> = { DRAFT:"Borrador",OPEN:"Abierta",IN_CONVERSATION:"En conversación",QUOTE_SENT:"Cotización enviada",QUOTE_ACCEPTED:"Cotización aceptada",CLOSED_BY_REQUESTER:"Cerrada por cliente",CLOSED_BY_PROVIDER:"Cerrada por proveedor",COMPLETED:"Completada",CANCELLED:"Cancelada",DISPUTED:"En revisión" };
